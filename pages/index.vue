<template>
  <main>
    <nav class="flex justify-end pt-5 xl:mx-20">
      <div>
        <button
          class="btn capitalize rounded-xl bg-primary text-primary shadow-sm text-lg font-medium hover:bg-primary"
        >
          Archives
          <img class="w-[22px]" src="@/assets/icons/archive.svg" alt="" />
        </button>
      </div>
    </nav>
    <div
      class="flex w-12/12 flex-col xl:flex-row items-center xl:items-start xl:mx-20 mt-4"
    >
      <section class="w-12/12 md:w-10/12 lg:w-8/12 xl:w-4/12 px-4">
        <div class="flex items-center py-3 px-2 bg-primary mb-3 rounded-xl shadow-sm">
